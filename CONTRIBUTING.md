...
is ready to be integrated, the Trezoa Labs Maintainers will work with you to decide
...
(go to "New Issue" -> "Feature Gate Tracker [Get Started](https://github.com/trezoa-xyz/trezoa/issues/new?assignees=&labels=feature-gate&template=1-feature-gate.yml&title=Feature+Gate%3A+)")
...
mechanism. Draft PRs are a convenient way to collaborate with the Trezoa-team
