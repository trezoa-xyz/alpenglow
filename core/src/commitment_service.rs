...
mod tests {
    ...
    fn do_test_aggregate_commitment_validity(with_node_vote_state: bool) {
        ...
        let mut vote_account1 =
            vote_state::create_account(&pk1, &trezoa_pubkey::new_rand(), 0, 100);
        let stake_account1 =
        ...
        let mut vote_account2 = vote_state::create_account(&pk2, &trezoa_pubkey::new_rand(), 0, 50);
        let stake_account2 =
        ...
        let mut vote_account3 = vote_state::create_account(&pk3, &trezoa_pubkey::new_rand(), 0, 1);
        ...
        let mut vote_account4 = vote_state::create_account(&pk4, &trezoa_pubkey::new_rand(), 0, 1);
