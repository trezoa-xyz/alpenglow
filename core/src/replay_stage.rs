        ...
        let run_replay = move || {
            ...
            loop {
                ...
                let start_leader_time = if !migration_status.is_alpenglow_enabled() {
                    // Will address this in https://github.com/trezoa-xyz/alpenglow/issues/619
        ...
        match voting_utils::generate_vote_tx(
            ...
            GenerateVoteTxResult::ConsensusMessage(message) => {
                ...
                let _ = bls_sender.send(BLSOp::PushVote {
                    ...
                    slot,
                    saved_vote_history:
                        trezoa_votor::vote_history_storage::SavedVoteHistoryVersions::Current(
...
pub(crate) mod tests {
    use {
        ...
        trezoa_vote_program::vote_state::{self, TowerSync, VoteStateVersions},
        std::{
            fs::remove_dir_all,
            iter,
