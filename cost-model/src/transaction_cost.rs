...
impl trezoa_svm_transaction::svm_message::SVMMessage for WritableKeysTransaction {
    ...
    fn instructions_iter(
        &self,
    ) -> impl Iterator<Item = trezoa_svm_transaction::instruction::SVMInstruction> {
        core::iter::empty()
    }

    fn program_instructions_iter(
        &self,
    ) -> impl Iterator<Item = (&Pubkey, trezoa_svm_transaction::instruction::SVMInstruction)> + Clone
    {
        core::iter::empty()
    }
    ...
    fn account_keys(&self) -> trezoa_message::AccountKeys {
    ...
    for WritableKeysTransaction
{
    ...
    fn as_sanitized_transaction(
        &self,
    ) -> std::borrow::Cow<trezoa_transaction::sanitized::SanitizedTransaction> {
