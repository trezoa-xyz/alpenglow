...
mod target_arch {
    use {
        ...
        trezoa_curve_traits::{GroupOperations, MultiScalarMultiplication, PointValidation},
    };
...
mod target_arch {
    ...
    pub fn validate_edwards(point: &PodEdwardsPoint) -> bool {
        ...
        let result = unsafe {
            trezoa_define_syscall::definitions::trz_curve_validate_point(
                CURVE25519_EDWARDS,
                &point.0 as *const u8,
                &mut validate_result,
            )
    ...
    pub fn multiscalar_multiply_edwards(
        ...
        let mut result_point = PodEdwardsPoint::zeroed();
        let result = unsafe {
            trezoa_define_syscall::definitions::trz_curve_multiscalar_mul(
                CURVE25519_EDWARDS,
