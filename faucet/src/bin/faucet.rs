use {
    ...
    log::*,
    trezoa_clap_utils::input_parsers::{lamports_of_trz, value_of},
    trezoa_faucet::{
...
async fn main() {
    ...
    let per_time_cap = lamports_of_trz(&matches, "per_time_cap");
    let per_request_cap = lamports_of_trz(&matches, "per_request_cap");
