...
pub mod stricter_abi_and_runtime_constraints {
    trezoa_pubkey::declare_id!("CxeBn9PVeeXbmjbNwLv6U4C6svNxnC4JX6mfkvgeMocM");
}
...
pub mod relax_intrabatch_account_locks {
    trezoa_pubkey::declare_id!("ENTRYnPAoT5Swwx73YDGzMp3XnNH1kxacyvLosRHza1i");
}
...
pub mod alpenglow {
    use {trezoa_keypair::Keypair, std::sync::LazyLock};
    ...
    trezoa_pubkey::declare_id!("8KpruRFrT59jQ9NfFX9DU6j8a1hW7y6xchvZNQ5rxD4P");
}
...
pub mod alpenglow_vat_and_limit_validators {
    trezoa_pubkey::declare_id!("3SJUjJgvYwdH5auT45RXwRnZ5VJVyQCvFU9rFvNpjgsC");
}
