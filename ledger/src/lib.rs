...
conditional_mod::conditional_vis_mod!(shred, feature="trezoa-unstable-api", pub,pub(crate));
mod shredder;
...
pub mod macro_reexports {
    pub use trezoa_accounts_db::hardened_unpack::MAX_GENESIS_ARCHIVE_UNPACKED_SIZE;
}
