...
pub const AG_DEBUG_LOG_FILTER: &str =
    "error,trezoa_core::replay_stage=info,trezoa_local_cluster=info,local_cluster=info,\
     trezoa_core::block_creation_loop=trace,trezoa_votor=trace,trezoa_votor::voting_service=info,\
