use {
    ...
    trezoa_votor::vote_history_storage::FileVoteHistoryStorage,
    trezoa_votor_messages::migration::GENESIS_CERTIFICATE_ACCOUNT,
    std::{
        collections::HashMap,
        io::{Error, Result},
        iter,
...
impl LocalCluster {
    ...
    pub fn init(
        ...
        if alpenglow_mode == AlpenglowMode::PreMigration {
            genesis_config
                .accounts
                .remove(&trezoa_feature_set::alpenglow::id());
