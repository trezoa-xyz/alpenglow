...
#[deprecated(
    since = "3.0.0",
    note = "Please use the equivalent struct from trezoa-net-utils::sockets"
)]
...
#[deprecated(
    since = "3.0.0",
    note = "Please use the equivalent from trezoa-net-utils::sockets"
)]
#[allow(deprecated)]
...
#[deprecated(
    since = "3.0.0",
    note = "Please use the eqiuvalent from trezoa-net-utils::sockets"
)]
#[allow(deprecated)]
