...
extern uint64_t entrypoint(const uint8_t *input) {
  ...
  switch (params.data[0]) {
    case(1):
      trz_log("return success");
      return SUCCESS;
    case(2):
      trz_log("return a builtin");
      return ERROR_INVALID_ACCOUNT_DATA;
    case(3):
      trz_log("return custom error 0");
      return ERROR_CUSTOM_ZERO;
    case(4):
      trz_log("return custom error 42");
      return 42;
    case(5):
      trz_log("return an invalid error");
      return ERROR_INVALID_ACCOUNT_DATA + 1;
    case(6):
      trz_log("return unknown builtin");
      return TO_BUILTIN(50);
    case(9):
      trz_log("return pubkey error");
