...
use {
    ...
    trezoa_loader_v4_interface::instruction as loader_v4_instruction,
...
fn test_program_sbf_loader_deprecated() {
    ...
    for program in programs.iter() {
        ...
        genesis_config
            .accounts
            .remove(&trezoa_feature_set::disable_deploy_of_alloc_free_syscall::id())
            .unwrap();
        let (bank, bank_forks) = Bank::new_with_bank_forks_for_tests(&genesis_config);
...
fn assert_instruction_count() {
    ...
    {
        programs.extend_from_slice(&[
            ("trezoa_sbf_rust_128bit", 801),
            ("trezoa_sbf_rust_alloc", 4983),
            ("trezoa_sbf_rust_custom_heap", 339),
            ("trezoa_sbf_rust_dep_crate", 22),
            ("trezoa_sbf_rust_iter", 1414),
            ("trezoa_sbf_rust_many_args", 1287),
            ("trezoa_sbf_rust_mem", 1322),
            ("trezoa_sbf_rust_membuiltins", 329),
            ("trezoa_sbf_rust_noop", 334),
            ("trezoa_sbf_rust_param_passing", 109),
            ("trezoa_sbf_rust_rand", 312),
            ("trezoa_sbf_rust_sanity", 17902),
            ("trezoa_sbf_rust_secp256k1_recover", 88670),
            ("trezoa_sbf_rust_sha", 22175),
        ]);
    }
...
fn test_program_sbf_disguised_as_sbf_loader() {
    ...
    for program in programs.iter() {
        ...
        bank.deactivate_feature(&trezoa_feature_set::remove_bpf_loader_incorrect_program_id::id());
...
fn test_program_reads_from_program_account() {
    use trezoa_loader_v4_interface::state as loader_v4_state;
    trezoa_logger::setup();
...
fn test_program_sbf_deplete_cost_meter_with_divide_by_zero() {
    ...
    let (bank, program_id) = load_program_of_loader_v4(
        ...
        &mint_keypair,
        &authority_keypair,
        "trezoa_sbf_rust_divide_by_zero",
    );
