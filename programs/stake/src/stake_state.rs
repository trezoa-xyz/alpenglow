...
#[deprecated(
    since = "1.8.0",
    note = "Please use `trezoa_stake_interface::state` instead"
)]
pub use trezoa_stake_interface::state::*;
use {
    ...
    trezoa_stake_interface::stake_flags::StakeFlags,
    trezoa_vote_interface::state::{VoteStateV3, VoteStateV4},
};
