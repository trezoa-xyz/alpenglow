...
use {
    ...
    trezoa_transaction_context::{BorrowedInstructionAccount, InstructionContext},
...
mod tests {
    use {
        ...
        trezoa_vote_interface::instruction::{tower_sync, tower_sync_switch},
    ...
    fn create_test_account() -> (Pubkey, AccountSharedData) {
        ...
        (
            vote_pubkey,
            vote_state::create_account(&vote_pubkey, &trezoa_pubkey::new_rand(), 0, balance),
        )
    }
