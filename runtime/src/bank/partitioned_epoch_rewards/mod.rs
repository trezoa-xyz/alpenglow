...
mod tests {
    use {
        ...
        trezoa_vote_interface::state::{VoteStateVersions, MAX_LOCKOUT_HISTORY},
        trezoa_vote_program::vote_state::{self, TowerSync},
        std::sync::{Arc, RwLock},
    };
    ...
    fn test_rewards_period_system_transfer() {
        ...
        let new_stake_account = Account::from(trezoa_stake_program::stake_state::create_account(
            &new_stake_address,
            &vote_key,
            &vote_account.into(),
            &genesis_config.rent,
