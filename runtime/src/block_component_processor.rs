use {
    crate::bank::Bank,
    trezoa_bls_cert_verify::cert_verify::verify_cert_get_total_stake,
    log::*,
    trezoa_clock::{Slot, DEFAULT_MS_PER_SLOT},
    trezoa_entry::block_component::{
...
impl BlockComponentProcessor {
    ...
    ///
    /// Refer to https://github.com/trezoa-foundation/trezoa-improvement-documents/pull/363 for
...
mod tests {
    use {
        ...
        trezoa_program::{hash::Hash, pubkey::Pubkey},
        trezoa_votor_messages::reward_certificate::{
