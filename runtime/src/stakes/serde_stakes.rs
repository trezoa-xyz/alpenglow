use {
    ...
    trezoa_stake_program::stake_state::Stake,
...
mod tests {
    use {
        super::*, crate::stakes::StakesCache, rand::Rng, trezoa_rent::Rent,
        trezoa_stake_interface::state::Delegation, trezoa_stake_program::stake_state,
    ...
    fn test_serde_stakes_to_delegation_format() {
        ...
        for _ in 0..rng.gen_range(5usize..10) {
            ...
            let vote_account = vote_state::create_account(
                &vote_pubkey,
                &trezoa_pubkey::new_rand(),  // node_pubkey
