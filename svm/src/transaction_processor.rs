...
impl<FG: ForkGraph> TransactionBatchProcessor<FG> {
    ...
    pub fn get_environments_for_epoch(
        &self,
        epoch: Epoch,
    ) -> Option<trezoa_program_runtime::loaded_programs::ProgramRuntimeEnvironments> {
...
mod tests {
    ...
    use {
        ...
        trezoa_transaction_error::{TransactionError, TransactionError::DuplicateInstruction},
