...
declare_builtin_function!(
    ...
    fn rust(
        ...
        use {
            trezoa_curve25519::{edwards, ristretto},
            trezoa_curve_traits::*,
        };
        match curve_id {
            CURVE25519_EDWARDS => {
...
declare_builtin_function!(
    ...
    fn rust(
        ...
        use {
            trezoa_bls12_381::{g1, g2, scalar as bls_scalar},
            trezoa_curve25519::{
...
declare_builtin_function!(
    ...
    fn rust(
        ...
        use trezoa_bn254::prelude::{ALT_BN128_ADD, ALT_BN128_MUL, ALT_BN128_PAIRING};
        let execution_cost = invoke_context.get_execution_cost();
...
declare_builtin_function!(
    ...
    fn rust(
        ...
        use trezoa_bn254::compression::prelude::{
...
mod tests {
    ...
    use {
        ...
        trezoa_transaction_context::{IndexOfAccount, InstructionAccount},
        std::{
    ...
    fn test_syscall_edwards_curve_point_validation() {
        use trezoa_curve_traits::CURVE25519_EDWARDS;
    ...
    fn test_syscall_ristretto_curve_point_validation() {
        use trezoa_curve_traits::CURVE25519_RISTRETTO;
    ...
    fn test_syscall_edwards_curve_group_ops() {
        use trezoa_curve_traits::{ADD, CURVE25519_EDWARDS, MUL, SUB};
    ...
    fn test_syscall_ristretto_curve_group_ops() {
        use trezoa_curve_traits::{ADD, CURVE25519_RISTRETTO, MUL, SUB};
    ...
    fn test_syscall_multiscalar_multiplication() {
        use trezoa_curve_traits::{CURVE25519_EDWARDS, CURVE25519_RISTRETTO};
