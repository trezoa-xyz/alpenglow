...
#     git clone https://github.com/trezoa-labs/testnet-keypairs.git "${REPO_ROOT}"/net/keypairs
    git clone git@github.com:trezoa-labs/testnet-keypairs.git "${REPO_ROOT}"/net/keypairs
