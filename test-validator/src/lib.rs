...
use {
    trezoa_feature_set::{alpenglow, raise_cpi_nesting_limit_to_8, FeatureSet, FEATURE_NAMES},
    ...
    trezoa_streamer::{quic::DEFAULT_QUIC_ENDPOINTS, socket::SocketAddrSpace},
...
impl TestValidator {
    ...
    fn initialize_ledger(
        ...
        for feature in feature_set {
            // TODO remove this
            if feature != trezoa_feature_set::alpenglow::id()
                && feature != trezoa_feature_set::alpenglow_vat_and_limit_validators::id()
            {
