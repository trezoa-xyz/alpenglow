        ...
        Some(stake_args) => {
            ...
            let mut instructions = match &stake_args.sender_stake_args {
                ...
                Some(sender_stake_args) => {
                    ...
                    instructions.append(&mut stake_instruction::tplit(
...
mod tests {
    ...
    #[test]
    fn test_set_tplit_stake_lockup() {
    ...
    fn test_check_payer_balances_distribute_tokens_single_payer() {
        ...
        let fees = client
            ...
            .unwrap();
        let fees_in_trz = fees as f64 / LAMPORTS_PER_TRZ as f64;
