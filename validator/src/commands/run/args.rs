use {
    ...
    trezoa_runtime::snapshot_utils::{SnapshotVersion, SUPPORTED_ARCHIVE_COMPRESSION},
...
mod tests {
    ...
    impl Default for RunArgs {
        fn default() -> Self {
            ...
            let logfile = format!("trezoa-validator-{}.log", identity_keypair.pubkey());
            let entrypoints = vec![];
    ...
    fn verify_args_struct_by_command_run_with_log() {
        ...
        {
            let expected_args = RunArgs {
                logfile: "trezoa-validator-".to_string()
