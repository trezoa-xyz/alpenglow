...
pub(crate) fn set_root(
    ...
    *pending_blocks = pending_blocks.tplit_off(&new_root);
    *finalized_blocks = finalized_blocks.tplit_off(&(new_root, Hash::default()));
    *received_shred = received_shred.tplit_off(&new_root);
